...
import { chineseRoutes } from '@samatech/learn-chinese'
import { vietnameseRoutes } from '@samatech/learn-vietnamese'
...
router.afterEach((to, _from) => {
  ...
  document.title = to.meta.title || parentTitle || 'Learn Languages'
})
